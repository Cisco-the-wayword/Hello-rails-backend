...
<a href="https://github.com/Cisco-the-wayword/hello-react-frontend/">hello-react-frontend</a>
...
```sh
  cd my-folder
  git clone https://github.com/Cisco-the-wayword/hello-rails-backend.git
```
